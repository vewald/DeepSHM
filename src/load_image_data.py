...
class ImageDataSource:
    ...
    def __init__(self, train_dir_path = r"data\single_scene1\combi_1\rgb\training", 
				 validation_dir_path = r"data\single_scene1\combi_1\rgb\validation", 
				 test_dir_path = r"data\single_scene1\combi_1\rgb\test"):
    ...
    def crawl_test_dir(self):
        for dirname, dirnames, filenames in os.walk(self.test_dir_full_path):
			...
			# Advanced usage: editing the 'dirnames' list will stop os.walk() from recursing into there.
            if '.git' in dirnames:
...
if __name__ == "__main__":
    ImageDataSource()
    x = os.path.join(os.path.dirname(os.getcwd()), r"data\single_scene1\combi_1\rgb\test")
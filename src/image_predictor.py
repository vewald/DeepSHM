...
class ImagePredictor:
	...
	def __init__(self, model_name):
		...
		self.saved_trained_model_dir_path = os.path.join(os.path.dirname(os.getcwd()), r"src")
...
if __name__ == "__main__":
	...
	plotter.VisTool().plot_confusion_matrix(conf_mat, pred_obj.get_all_test_class_labels())